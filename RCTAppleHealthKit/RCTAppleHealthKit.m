...
RCT_EXPORT_METHOD(getIrregularHeartRhythmEvent:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self vitals_getIrregularHeartRhythmEvent:input callback:callback];
}
